...
var _user$project$SignupForm$getErrors = function (model) {
	return {
		username: _elm_lang$core$Native_Utils.eq(model.username, '') ? 'Plase enter a username!' : '',
...
if (typeof _user$project$SignupForm$main !== 'undefined') {
    _user$project$SignupForm$main(Elm['SignupForm'], 'SignupForm', undefined);
}
